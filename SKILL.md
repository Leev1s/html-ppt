...
| 如果用户说... | 推荐风格 |
|---|---|
| "Sika 案例" / "项目故事" / "杂志感" / "人文" / 不指定 | **A · Sika 电子杂志风** |
| "Sika 数据" / "施工流程" / "瑞士风" / "Swiss Style" / "Helvetica" / "极简" / "网格" / "信息图" / "数据驱动" | **B · Sika 瑞士国际主义风** |
...
**固定变量来源**:
- Style A: `references/themes.md`
- Style B: `references/themes-swiss.md`
...
- **Swiss grid as structure**:Style B 保留 Massimo Vignelli / Helvetica 式结构,但颜色必须回到 Sika Corporate。
- **Editorial casebook as narrative**:Style A 保留杂志叙事,但纸张、标题和装饰必须使用 Sika 红黄暖底。
