# Sika Swiss Map Component

用于 Sika 项目地点、施工路线、工厂/仓库/渠道分布、城市案例和事件点位等内容。它不是新的 Swiss 正文版式,而是 **S08 Duo Compare 的右侧插槽扩展**:左侧仍是解释卡片,右侧替换为地图组件,配色必须继承 Sika Red / Sika Yellow / 暖砂灰。
